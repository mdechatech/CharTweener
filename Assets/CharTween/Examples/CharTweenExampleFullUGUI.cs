    ...
    public class CharTweenExampleFullUGUI : MonoBehaviour
    {
        ...
        private void Feature_Transform_OffsetLocalWorldPosition()
        {
            TweenChars("Text 1", (textMesh, tweener, i) =>
                tweener.DOOffsetMoveZ(i, 100, 1).SetEase(Ease.InOutCubic).SetLoops(-1, LoopType.Yoyo));
        ...
        {
            TweenChars("Text 1", (textMesh, tweener, i) =>
                tweener.DOShakePosition(i, 1, 3f, 100, 90, false, false).SetLoops(-1, LoopType.Restart));
            TweenChars("Text 2", (textMesh, tweener, i) =>
